...
INSERT INTO Employee
  (employeeName, employeeType, employeeId, CustomerId, deptId)
VALUES
...
VALUES
  ('place_007', '10am-5pm','Rowes Wharf you can board the Odyssey cruise through Boston Harbor Castle Island Georges Island east the Boston Light Little Brewster Island back north Charlestown Naval Yard before returning the wharf.')
  ('place_600', '9am-8pm', 'north a Boston Italian place.'),
  ('place_567', '11am-5pm', 'Overlooking the waterfront the New England Aquarium features more than 20000 fish aquatic animals representing over 550 species.A man-made Caribbean coral reef houses a large variety tropical fish underwater life including sharks turtles moray eels.');
